...
import { ContactSpaFormInputs } from '@/types/forms';
...
export default function ContactSpaForm() {
  ...
  } = useForm<ContactSpaFormInputs>({ resolver: yupResolver(contactUsSchema) });

  const onSubmit = async (data: ContactSpaFormInputs) => {
    const emailData = {
      email: data.email,
